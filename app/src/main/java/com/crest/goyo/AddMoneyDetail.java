...
public class AddMoneyDetail extends AppCompatActivity implements View.OnClickListener, OneClickPaymentListener {
    ...
    public void generateHashFromSDK(PaymentParams mPaymentParams, String salt) {
        ...
        Log.e("Payment Hash", "generateHashFromSDK: "+payuHashes.getPaymentHash() );
    ...
    public void generateHashFromServer(PaymentParams mPaymentParams) {
        ...
        Log.w("postParams", "generateHashFromServer: " + postParams);
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected PayuHashes doInBackground(String... postParams) {
            ...
            try {
                ...
                Log.w("Post Param [0]", "doInBackground: " + postParam);
                ...
                Log.w("postParamsByte ", "doInBackground: " + postParamsByte.toString());
                ...
                Log.w("Reponser Needed", "doInBackground: " + response);

                Iterator<String> payuHashIterator = response.keys();
                while (payuHashIterator.hasNext()) {
                    String key = payuHashIterator.next();
                    Log.w("Key", "doInBackground: " + key);
                    switch (key) {
...
/*sha512(key | txnid | amount | productinfo | firstname | email | udf1 | udf2 | udf3 | udf4 | udf5 || ||||
        ...
        String command = paymentModel.getKey() + "|" + "" + System.currentTimeMillis() + "|" + amount + "|" + paymentModel.getProductName() + "|" +
                paymentModel.getFirstName() + "|" + paymentModel.getEmail() + "|||||||||||" + "SybIl3mO";

        Log.w("Command", "navigateToBaseActivity: " + command);
...
/generateHashFromServer(mPaymentParams);
        PayuHashes payuHashes= new PayuHashes();
        payuHashes.setVasForMobileSdkHash("ffcdbf04fa5beefdcc2ad476c18bc410f02b3968e7f4f54e8f43f1e1a310bb32e3b4dec9305232bb89db5b1d0c009a53bcace6f4bd8ec2f695baf3d43ba730ce");
        payuHashes.setPaymentHash("ffcdbf04fa5beefdcc2ad476c18bc410f02b3968e7f4f54e8f43f1e1a310bb32e3b4dec9305232bb89db5b1d0c009a53bcace6f4bd8ec2f695baf3d43ba730ce");
        payuHashes.setPaymentRelatedDetailsForMobileSdkHash("ffcdbf04fa5beefdcc2ad476c18bc410f02b3968e7f4f54e8f43f1e1a310bb32e3b4dec9305232bb89db5b1d0c009a53bcace6f4bd8ec2f695baf3d43ba730ce");
        payuHashes.setDeleteCardHash("ffcdbf04fa5beefdcc2ad476c18bc410f02b3968e7f4f54e8f43f1e1a310bb32e3b4dec9305232bb89db5b1d0c009a53bcace6f4bd8ec2f695baf3d43ba730ce");
        payuHashes.setStoredCardsHash("ffcdbf04fa5beefdcc2ad476c18bc410f02b3968e7f4f54e8f43f1e1a310bb32e3b4dec9305232bb89db5b1d0c009a53bcace6f4bd8ec2f695baf3d43ba730ce");
        payuHashes.setEditCardHash("ffcdbf04fa5beefdcc2ad476c18bc410f02b3968e7f4f54e8f43f1e1a310bb32e3b4dec9305232bb89db5b1d0c009a53bcace6f4bd8ec2f695baf3d43ba730ce");
        payuHashes.setSaveCardHash("ffcdbf04fa5beefdcc2ad476c18bc410f02b3968e7f4f54e8f43f1e1a310bb32e3b4dec9305232bb89db5b1d0c009a53bcace6f4bd8ec2f695baf3d43ba730ce");
        payuHashes.setCheckOfferStatusHash("ffcdbf04fa5beefdcc2ad476c18bc410f02b3968e7f4f54e8f43f1e1a310bb32e3b4dec9305232bb89db5b1d0c009a53bcace6f4bd8ec2f695baf3d43ba730ce");
        launchSdkUI(payuHashes);
        //generateHashFromSDK(mPaymentParams, "13p0PXZk");*//*
    ...
    private void generateParamsForHash() {
        ...
        generateHashFromMyServer(postParams);
    }

    private void generateHashFromMyServer(final String postParams) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.getInt("success") == 1) {
                        ...
                        PayuHashes payuHashes = new PayuHashes();
                        payuHashes.setPaymentHash(jsonObject.getString("data"));
                        payuHashes.setVasForMobileSdkHash(jsonObject.getString("data"));
                        payuHashes.setPaymentRelatedDetailsForMobileSdkHash(jsonObject.getString("data"));
                        launchSdkUI(payuHashes);
                    } else {
                        Log.e("getPaymentMethods", "onResult: Null Response");
                    }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("stringVar", postParams);
                return param;
            }
        };
...
*/
/* {
  "payment_hash": "b1c60915951d9931bdd320911d58ab92ac1a47c7cf7594a3fbcc6e75a01e539304a297060b5f7a690fb310e5bce77ada22dabf6eea8ee5cf349dc8f767ce36f5",
  "payment_related_details_for_mobile_sdk_hash": "eebc655d2ac9a22e36bd2d60e54cb2329e65d6b9a0ee1f6317afb3a307c9cbcac9dfdd2c8006d0e484f50302bb7147e9de1aa84c692ca7dda57418226e7d139f",
  "delete_user_card_hash": "032945986ccd2053304689b2b1fefe446661cf2c0b02c2ed7b62b4b540fdef46637cf2e9845233a9dedc0f9133134abb9d4cf1f64fc051eec8d023e4354c1ae5",
  "edit_user_card_hash": "1c951a2afb10a11d6065b5137a4832005020a8a60873478834a96d100f24eeecaddae917fad2fae488afc0fdd76fd081fced54793f6965d3388968f435b7afb4",
  "save_user_card_hash": "f0a1d1accbafdee81b602ff827c57d972c2adeaf6a86015d9cd38b1903a2ea262f057e197a351f870f698e754c4d21383b3e596c4ccfee96949e9e386a6fdfbc",
  "get_user_cards_hash": "250d2e8c30620e2da82eba98fe52dfe7104af29847c54425949a71735ae7f62f6a116866eef41c306e2656137672a03d64ebb92b18e794b28f69c0d62a987fdb",
